  ...
  const handleVerify = async () => {
    try {
      ...
      if (response.data) {
        ...
        console.log("OTP verification successful with token:", token); // Debug log
        
        // Dispatch login action with basic user data (no profile data)
        ...
        // Navigate to CreateProfile after successful OTP verification
